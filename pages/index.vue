<template>
  <UContainer
    class="py-16 text-center items-center justify-center flex flex-col gap-4"
  >
    <img
    ...
    <p class="text-lg max-w-2xl mx-auto mb-8">
      Passionate web developer focused on front-end, modern interfaces, and
      smooth user experiences. Welcome to my portfolio!
    </p>

    <div class="flex justify-center gap-4 flex-wrap">
      <UButton
        label="Look at my work"
